...
public class UIConstants {
    ...
    public static final Color BTN_BLUE = new Color(52, 152, 219);
    public static final Color BTN_ORANGE = new Color(230, 126, 34);
    public static final Color BTN_GRAY = new Color(149, 165, 166);
    public static final Color BTN_PURPLE = new Color(142, 68, 173);
    public static final Color BTN_RULER = new Color(243, 156, 18);
}
